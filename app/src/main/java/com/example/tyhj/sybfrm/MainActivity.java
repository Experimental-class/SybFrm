...
import com.example.tyhj.sybfrm.initlogin.ChangePassword;

import com.example.tyhj.sybfrm.initlogin.ChangePassword_;
import com.example.tyhj.sybfrm.initlogin.Signup;
...
public class MainActivity extends AppCompatActivity {
    ...
    void changePassword(){
        startActivity(new Intent(MainActivity.this, ChangePassword_.class));
    }
    //登陆
    @Click(R.id.btnLogin)
    void login() {
    ...
    @UiThread
    void finishActivity(){
        startActivity(new Intent(MainActivity.this,Home_.class));
        this.finish();
    }
